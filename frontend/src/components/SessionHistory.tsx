...
import { History, Clock, ChevronRight, ChevronDown, ChevronUp } from "lucide-react"
...
export function SessionHistory() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className={`transition-all duration-200 ease-in-out overflow-hidden ${isOpen ? 'max-h-[300px] opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="px-3 space-y-1 pb-2 overflow-y-auto max-h-[300px]">
                    {loading ? (
